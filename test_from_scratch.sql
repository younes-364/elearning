...
-- x: ['<%= statisticsItems[0].TRAINING_TITLE %>', '<%= statisticsItems[1].TRAINING_TITLE %>', '<%= statisticsItems[2].TRAINING_TITLE %>', '<%= statisticsItems[3].TRAINING_TITLE %>'],
-- y: ['<%= statisticsItems[0].MODULE_NUMBER %>', '<%= statisticsItems[1].MODULE_NUMBER %>', '<%= statisticsItems[2].MODULE_NUMBER %>', '<%= statisticsItems[3].MODULE_NUMBER %>'],